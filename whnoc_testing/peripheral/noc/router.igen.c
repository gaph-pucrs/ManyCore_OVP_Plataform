...
static void installSlavePorts(void) {
    handles.localPort = ppmCreateSlaveBusPort("localPort", 16);
...
static void installRegisters(void) {
    ...
    ppmCreateRegister("regs_txLocal",
        0,
        handles.localPort,
        4,
        4,
        ...
        txWrite,
        view32,
        &(localPort_regs_data.txLocal.value),
        True
    );
    ppmCreateRegister("regs_rxLocal",
        0,
        handles.localPort,
        8,
        4,
        ...
        rxWrite,
        view32,
        &(localPort_regs_data.rxLocal.value),
        True
    );
    ppmCreateRegister("regs_readDone",
        0,
        handles.localPort,
        12,
        4,
        ...
        rdWrite,
        view32,
        &(localPort_regs_data.readDone.value),
        True
    );
...
int main(int argc, char *argv[]) {
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc2_node, "A router peripheral");
    }
