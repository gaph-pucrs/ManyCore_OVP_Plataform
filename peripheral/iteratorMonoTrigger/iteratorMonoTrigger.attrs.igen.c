...
Uns8 iterationPort49_pnsd[8];
Uns8 iterationPort50_pnsd[8];
Uns8 iterationPort51_pnsd[8];
Uns8 iterationPort52_pnsd[8];
Uns8 iterationPort53_pnsd[8];
Uns8 iterationPort54_pnsd[8];
Uns8 iterationPort55_pnsd[8];
Uns8 iterationPort56_pnsd[8];
Uns8 iterationPort57_pnsd[8];
Uns8 iterationPort58_pnsd[8];
Uns8 iterationPort59_pnsd[8];
Uns8 iterationPort60_pnsd[8];
Uns8 iterationPort61_pnsd[8];
Uns8 iterationPort62_pnsd[8];
Uns8 iterationPort63_pnsd[8];
Uns8 iterationPort64_pnsd[8];
Uns8 iterationPort65_pnsd[8];
Uns8 iterationPort66_pnsd[8];
Uns8 iterationPort67_pnsd[8];
Uns8 iterationPort68_pnsd[8];
Uns8 iterationPort69_pnsd[8];
Uns8 iterationPort70_pnsd[8];
Uns8 iterationPort71_pnsd[8];
Uns8 iterationPort72_pnsd[8];
Uns8 iterationPort73_pnsd[8];
Uns8 iterationPort74_pnsd[8];
Uns8 iterationPort75_pnsd[8];
Uns8 iterationPort76_pnsd[8];
Uns8 iterationPort77_pnsd[8];
Uns8 iterationPort78_pnsd[8];
Uns8 iterationPort79_pnsd[8];
Uns8 iterationPort80_pnsd[8];
...
static ppmPacketnetPort packetnetPorts[] = {
    ...
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort49_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort49,
        .packetnetCB     = iteration49,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort50_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort50,
        .packetnetCB     = iteration50,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort51_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort51,
        .packetnetCB     = iteration51,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort52_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort52,
        .packetnetCB     = iteration52,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort53_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort53,
        .packetnetCB     = iteration53,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort54_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort54,
        .packetnetCB     = iteration54,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort55_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort55,
        .packetnetCB     = iteration55,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort56_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort56,
        .packetnetCB     = iteration56,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort57_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort57,
        .packetnetCB     = iteration57,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort58_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort58,
        .packetnetCB     = iteration58,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort59_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort59,
        .packetnetCB     = iteration59,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort60_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort60,
        .packetnetCB     = iteration60,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort61_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort61,
        .packetnetCB     = iteration61,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort62_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort62,
        .packetnetCB     = iteration62,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort63_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort63,
        .packetnetCB     = iteration63,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort64_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort64,
        .packetnetCB     = iteration64,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort65_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort65,
        .packetnetCB     = iteration65,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort66_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort66,
        .packetnetCB     = iteration66,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort67_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort67,
        .packetnetCB     = iteration67,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort68_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort68,
        .packetnetCB     = iteration68,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort69_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort69,
        .packetnetCB     = iteration69,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort70_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort70,
        .packetnetCB     = iteration70,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort71_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort71,
        .packetnetCB     = iteration71,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort72_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort72,
        .packetnetCB     = iteration72,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort73_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort73,
        .packetnetCB     = iteration73,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort74_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort74,
        .packetnetCB     = iteration74,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort75_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort75,
        .packetnetCB     = iteration75,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort76_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort76,
        .packetnetCB     = iteration76,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort77_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort77,
        .packetnetCB     = iteration77,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort78_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort78,
        .packetnetCB     = iteration78,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort79_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort79,
        .packetnetCB     = iteration79,
        .userData        = (void*)0
    },
    {
        ...
        .mustBeConnected = 0,
        .description     = 0,
        .sharedData      = iterationPort80_pnsd,
        .sharedDataBytes = 8,
        .handlePtr       = &handles.iterationPort80,
        .packetnetCB     = iteration80,
        .userData        = (void*)0
    },
    { 0 }
};
