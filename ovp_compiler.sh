...
harness/harness.${IMPERAS_ARCH}.exe \
     ...
     --program cpu64=application/application64.${CROSS}.elf $* \
     --program cpu65=application/application65.${CROSS}.elf $* \
     --program cpu66=application/application66.${CROSS}.elf $* \
     --program cpu67=application/application67.${CROSS}.elf $* \
     --program cpu68=application/application68.${CROSS}.elf $* \
     --program cpu69=application/application69.${CROSS}.elf $* \
     --program cpu70=application/application70.${CROSS}.elf $* \
     --program cpu71=application/application71.${CROSS}.elf $* \
     --program cpu72=application/application72.${CROSS}.elf $* \
     --program cpu73=application/application73.${CROSS}.elf $* \
     --program cpu74=application/application74.${CROSS}.elf $* \
     --program cpu75=application/application75.${CROSS}.elf $* \
     --program cpu76=application/application76.${CROSS}.elf $* \
     --program cpu77=application/application77.${CROSS}.elf $* \
     --program cpu78=application/application78.${CROSS}.elf $* \
     --program cpu79=application/application79.${CROSS}.elf $* \
     --program cpu80=application/application80.${CROSS}.elf $* \
