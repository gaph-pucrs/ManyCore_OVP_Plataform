...
int main(int argc, char **argv) {
    ...
    while(1){
        ...
        while(!get_mapping() && !get_migration_dst() && !finishSimulation_flag){ *clockGating_flag = TRUE; }
        ...
        *clockGating_flag = FALSE;
        ...
        // Sort2
        case sort_master_2:
            state = sortMaster2(state);
            break;
        case sort_slave1_2:
            state = sort_slave_2(0, state);
            break;
        case sort_slave2_2:
            state = sort_slave_2(1, state);
            break;
        case sort_slave3_2:
