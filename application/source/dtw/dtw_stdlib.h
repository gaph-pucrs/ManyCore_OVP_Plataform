...
char *dtw_itoa(unsigned int num)
{
   static char buf[12];
   static char buf2[12];
   int i,j;
...
char *dtw_itoh(unsigned int num)
{
   static char buf[11];
   int i;
   buf[10]=0;
...
char *dtw_strcpy(char *dst, const char *src) {
...
int dtw_strlen(const char *string) {
