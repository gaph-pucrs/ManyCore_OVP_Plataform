...
#define QUANTUM_TIME_SLICE            0.000001   // 10us quantum time step       
#define INSTRUCTIONS_PER_TIME_SLICE   (INSTRUCTIONS_PER_SECOND*QUANTUM_TIME_SLICE)  //10000 instructions per quantum
