...
/* Quantum defines */
#define INSTRUCTIONS_PER_SECOND       100000000 // 100MHz (assuming 1 instruction per cycle)
#define QUANTUM_TIME_SLICE            0.00001    // 10us quantum time step       
#define INSTRUCTIONS_PER_TIME_SLICE   (INSTRUCTIONS_PER_SECOND*QUANTUM_TIME_SLICE)  // 1.000 instructions per quantum
