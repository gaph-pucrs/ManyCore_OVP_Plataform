...
////////////////////////////////////////////////////////////////////////////////
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(cpu1Bus_b, "bport1", .slave=1, .addrLo=0x80000000ULL, .addrHi=0x8000000bULL)
            ),
            OP_NET_CONNECTIONS(
    ...
    opPeripheralNew(
        ...
        OP_CONNECTIONS(
            OP_BUS_CONNECTIONS(
                OP_BUS_CONNECT(cpu2Bus_b, "bport1", .slave=1, .addrLo=0x80000000ULL, .addrHi=0x8000000bULL)
            ),
            OP_NET_CONNECTIONS(
