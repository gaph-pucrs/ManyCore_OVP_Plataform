...
#
ihwconnect -instancename router1 -busslaveport bport1 -bus cpu1Bus -loaddress 0x80000000 -hiaddress 0x8000000B
ihwconnect -instancename router2 -busslaveport bport1 -bus cpu2Bus -loaddress 0x80000000 -hiaddress 0x8000000B
...
#
ihwconnect -instancename router1 -packetnetport pktPort -packetnet pktNet 
ihwconnect -instancename router2 -packetnetport pktPort -packetnet pktNet
