...
iadddocumentation -name Description -text "size for each burst transfer"  -handle DMACSP/ab8/config/burstSize
...
# Formal attributes
imodeladdformal -name enableNativeChannel -type Uns32
iadddocumentation -name Description -text "Enable native code on this channel"
