...
#
ihwconnect -instancename router1 -busslaveport bport1 -bus cpu1Bus -loaddress 0x80000000 -hiaddress 0x8000000F
ihwconnect -instancename router2 -busslaveport bport1 -bus cpu2Bus -loaddress 0x80000000 -hiaddress 0x8000000F
